...
inputs = {
  ...
  app_image = "816070112642.dkr.ecr.eu-west-1.amazonaws.com/service_b"
  app_port = 8000
  fargate_cpu = 1024
  fargate_memory = 2048
  ecs_min_tasks = 1
  ...
  alb_route_path = "/service-B" #Context path of springboot application
  alb_listner_priority = 105
}
